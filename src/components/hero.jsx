  ...
  return (
    <section class="pub w-full h-auto flex flex-col gap-10 md:gap-5 items-center justify-center md:mt-[10vh] bg-white p-2 text-center md:p-0">
      ...
      <div class="pub_b w-full md:h-[60vh] flex flex-col md:flex-row md:mt-[8vh]">
        <div data-aos="fade-right" class="pub_gauche w-full md:w-1/2 flex justify-center items-center ">
          <img src={hero_G} alt="" class="w-full h-auto object-cover" />
        </div>
        <div data-aos="fade-left" class="pub_droite w-full md:w-1/2 p-2 md:p-10 flex flex-wrap justify-center items-center gap-[25%]">
