...
const hero = () => {
  ...
  return (
    <section class="pub w-full h-auto flex flex-col gap-10 md:gap-5 items-center justify-center md:mt-[10vh] bg-white p-2 text-center md:p-0">
      ...
      <div class="pub_b w-full h-auto md:h-[60vh] flex flex-col md:flex-row md:mt-[8vh]">
        <div data-aos="fade-right" class="pub_gauche w-full h-auto md:w-1/2 flex justify-center items-center relative md:pl-8">
          <img src={hero_G} alt="" class="w-full h-[55vh] md:h-auto object-contain opacity-30" />
          <p className=' absolute m-auto text-black font-semibold text-xl italic'>J’aime concevoir des applications fiables, apprendre de nouvelles technologies et transformer des idées en projets concrets. Curieux et rigoureux, je m’intéresse autant au développement front-end qu’au back-end, avec une attention particulière portée à la qualité du code et à la sécurité des services <br /><br />
