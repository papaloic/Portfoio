...
const Navbar = () => {
    ...
    return (
        <nav data-aos="fade-down" className="nav w-full h-[10vh] md:h-[15vh] top-0 fixed bg-white flex justify-between p-5 items-center shadow-xl/20 z-20">
            <div data-aos="fade-right" className="logo flex items-center w-[60%] md:w-[30%] md:ml-[5%]">
                ...
                <ul
                    tabIndex="-1"
                    className="menu_link_phone menu menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow ">
